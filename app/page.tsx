        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="relative">
            ...
            <div className="flex flex-col items-center text-center lg:px-32">
              ...
              {/* Subheading */}
              <p className="text-base sm:text-lg lg:text-xl text-slate-300 max-w-3xl mb-8 leading-relaxed">
                ObjectSpread is a community for curious minds, where independent researchers, 
                students, and thinkers come together to explore ideas, publish papers, and make 
